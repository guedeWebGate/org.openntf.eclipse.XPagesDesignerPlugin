...
import com.raidomatic.xml.XMLNodeList;
...
public class Folder extends AbstractDXLDesignNote {
	...
	public static String create(String databaseDocumentId, String name) throws Exception {
		...
		try {
			InputStream is = Stylesheet.class.getResourceAsStream("/org/openntf/eclipse/xdpe/publisher/frostillicus/dxl/folder.xml");
